...
reports.setSystemInfo("Project", "PayRoll");
reports.setSystemInfo("PC Name", "PC Jai");
reports.setSystemInfo("OS", "Windows 11");
reports.setSystemInfo("Test Done By", "jaisree"); 
sparkReporter.config().setDocumentTitle("Payroll project ");
